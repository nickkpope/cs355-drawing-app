...
class Ui_App_form(object):
    def setupUi(self, App_form):
        ...
        App_form.resize(828, 782)
        self.horizontalLayout_4 = QtGui.QHBoxLayout(App_form)
        ...
        self.horizontalLayout_2.addWidget(self.pb_color)
        self.sl_alpha = QtGui.QSlider(App_form)
        self.sl_alpha.setToolTip("")
        self.sl_alpha.setStatusTip("")
        self.sl_alpha.setWhatsThis("")
        self.sl_alpha.setMaximum(1000)
        self.sl_alpha.setSingleStep(1)
        self.sl_alpha.setSliderPosition(1000)
        self.sl_alpha.setOrientation(QtCore.Qt.Vertical)
        self.sl_alpha.setObjectName("sl_alpha")
        self.horizontalLayout_2.addWidget(self.sl_alpha)
